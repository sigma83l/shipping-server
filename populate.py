...
# Kullanıcı adı ve şifreni al
username = "hamedsedaghatgit83"
password = "Thisisme2005@"

# URL encode et
encoded_username = urllib.parse.quote_plus(username)
encoded_password = urllib.parse.quote_plus(password)
# MongoDB bağlantı dizesini oluştur
MONGO_URI = f"mongodb+srv://{encoded_username}:{encoded_password}@cluster0.kpry90i.mongodb.net/sp-shipping?retryWrites=true&w=majority"
# Your MongoDB Atlas connection string
# MONGO_URI = os.getenv("MONGO_URI")
# MONGO_URI = "mongodb+srv://hamedsedaghatgit83:Hitlerwashero2050@@cluster0.kpry90i.mongodb.net/sp-shipping?retryWrites=true&w=majority"
# print(MONGO_URI)
# Connect to MongoDB
try:
    ...
    db = client["sp-shipping"]  # Replace with your actual database name
    collection = db["tracking"]  # Replace with your collection name

    # Your data
    tracking_data =     [
            {
            "tracking_number": "H2SsJ93dM2",
    ...
    collection.insert_many(tracking_data)
